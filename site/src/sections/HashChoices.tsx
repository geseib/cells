...
const HashChoices: React.FC = () => (
  <section className="lesson" id="hash-choices">
    ...
    <p>
      ...
      everything — each trades balance, lookup speed, memory, and weight support differently. Each
      card below is a live mini-demo, and all six answer the same event from one shared control
      row:
    </p>
    <AlgoZoo />
